...
if not msg.SudoBase then return "♦️*│*هذا الامر يخص {المطور الاساسي} فقط  \n💥" end
local GetVerison = https.request('https://github.com/foza817/fawazmunshi.github.io/GetVersion.txt') or 0
...
if not msg.Admin then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير,الادمن} فقط  \n💥" end
...
🧔🏻|[مطور الـسـورس](https://t.me/FOZA817)
📨│ [قناه السورس](https://t.me/adnanrefaeii2) 
📨| [قروب السورس](https://t.me/adnanrefaei)
...
return sendMsg(msg.chat_id_,msg.id_,lovm[math.random(#lovm)])
elseif Text== "تف" then return sendMsg(msg.chat_id_,msg.id_,"تف ؏ وجهك البيض.")
...
return sendMsg(msg.chat_id_,msg.id_,"ادمن كفو عليك")
else 
